import MobileCategoryMenu from '@/layouts/mobile-menu/mobile-category-menu';
...
const MobileAuthorizedMenu = dynamic(
  () => import('@/layouts/mobile-menu/mobile-authorized-menu')
);
const MobileMainMenu = dynamic(
  () => import('@/layouts/mobile-menu/mobile-main-menu')
);
